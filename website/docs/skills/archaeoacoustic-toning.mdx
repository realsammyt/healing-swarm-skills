...
| ----------- | -------- | ----------------------------------------------------------- |
| `focus`     | Yes      | Frequency or site focus (e.g., "117 Hz King's Chamber")     |
...
| 117 Hz    | King's Chamber, Giza | Jahn, Devereux & Ibison 1996 (JASA) | Moderate       |
...
>
> Acoustic measurements of ancient sites are well-documented (Jahn, Devereux & Ibison 1996, JASA).
