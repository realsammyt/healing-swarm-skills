...
| Pattern | Best For | Effort |
|---------|----------|--------|
| [Project Analysis](/docs/integration/project-analysis) | Analyzing existing codebases | Low |
| [Healing Gamification](/docs/integration/healing-gamification) | Apps with engagement mechanics | Medium |
| [Narrative Healing](/docs/integration/narrative-healing) | Interactive fiction, visual novels | Medium |
| [Game Healing](/docs/integration/game-healing) | Video games | High |
...
- **[Gentle Errors](/docs/integration/gentle-errors)** - Transform harsh feedback into support
- **[Breathing Spaces](/docs/integration/breathing-spaces)** - Strategic pauses in workflows

### Specialized Patterns
- **[Project Analysis](/docs/integration/project-analysis)** - AI-powered HEAL assessment for any codebase
- **[Healing Gamification](/docs/integration/healing-gamification)** - Non-manipulative engagement
- **[Narrative Healing](/docs/integration/narrative-healing)** - Therapeutic interactive stories
- **[Game Healing](/docs/integration/game-healing)** - Wellness-centered game design
