# Healing Swarm Contraindications Database

> This cross-reference database is MANDATORY for all agents before recommending
> any practice. Failure to screen for contraindications violates the core
> ethics guardrail: "First, do no harm."

---

## Core Principle

**"Not every practice is safe for every person."**

Healing practices are powerful precisely because they affect physiology and
psychology. What benefits one person may harm another. Screening for
contraindications is not bureaucratic caution — it is an expression of care.
...
## CONTRAINDICATION TABLES BY CONDITION
...
Before recommending any practice, agents MUST gather the following:

### Tier 1: Universal Screening (ALWAYS Ask)

```
✅ "Do you have any medical conditions we should be aware of?"
✅ "Are you currently taking any medications?"
✅ "Are you pregnant or could you be pregnant?"
✅ "Have you had any surgery in the past 6 weeks?"
✅ "Do you have any heart or blood pressure concerns?"
✅ "Do you have any breathing conditions such as asthma?"
✅ "Have you ever had a seizure?"
```

### Tier 2: Mental Health Screening (Before Intensive/Transpersonal Practices)

```
✅ "Are you currently working with a mental health professional?"
✅ "Have you ever been diagnosed with a mental health condition?"
✅ "Have you ever experienced dissociation — feeling detached from your body or surroundings?"
✅ "Have you experienced trauma that still affects you?"
✅ "Have you ever had experiences that others might call psychotic, such as hearing voices or beliefs others found unusual?"
```
...
✅ "Are you pregnant?"
✅ "Do you have diabetes or peripheral neuropathy?"
```
...
✅ "Do you have PTSD or significant trauma history?"
✅ "Are you currently stable in your mental health?"
```
...
✅ "Do you have a grounding practice you use regularly?"
✅ "Do you have support available after the practice (friend, therapist)?"
```
...
### When to Require Written Clearance

```
✅ Any absolute contraindication the user wishes to explore modified versions of
✅ Pregnancy (for any physically active practice)
✅ Cardiovascular disease (for any breathwork, cold exposure, or intensive practice)
✅ Active psychotic disorder or recent psychotic episode (for any practice)
✅ Recent surgery (for physically active practices)
✅ Epilepsy (for breathwork, cold exposure, or transpersonal practices)
✅ Multiple concurrent conditions that interact
```

### When to Recommend (Not Require) Consultation

```
✅ Any relative contraindication
✅ New onset of symptoms during practice
✅ Desire to progress to more intensive practices
✅ Chronic conditions that may be affected by practice
...
```
"Before beginning [practice type], we recommend discussing this with your
healthcare provider. You might share the following with them:
...
Your provider can help determine if this is appropriate for you and suggest
any modifications."
```
...
```
1. User requests a practice
   │
2. Screen using Tier 1 questions
   │
   ├── Condition identified?
   │   ├── YES → Look up condition in contraindication table
   │   │         │
   │   │         ├── ABSOLUTE → Do NOT recommend. Offer safe alternatives.
   │   │         │               State: "This practice is not recommended for
   │   │         │               people with [condition] due to [risk]."
   │   │         │
   │   │         ├── RELATIVE → Offer modified version ONLY.
   ...
   │   │
   │   └── NO → Proceed with standard safety protocols
   │
3. For intensive/transpersonal practices → Tier 2 screening required
   │
4. For specific practice types → Tier 3 screening required
   │
5. Begin practice with appropriate safety framing
```
