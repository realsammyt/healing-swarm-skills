...
- [`adverse-response-guide`](../healing-swarm/content/adverse-response-guide.md)
...
- [`content/templates/adverse-event-log.md`](../healing-swarm/content/templates/adverse-event-log.md)
