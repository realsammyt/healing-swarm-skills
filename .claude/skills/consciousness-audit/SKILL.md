...
- [`content/templates/literacy-audit.md`](../healing-swarm/content/templates/literacy-audit.md)

**Safety context (load before generating output):**

- [`shared/consciousness-literacy-levels.md`](../healing-swarm/shared/consciousness-literacy-levels.md)
